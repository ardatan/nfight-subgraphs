...
import ExternalModule_4 from '@graphql-mesh/transform-prefix';
import ExternalModule_5 from './sources/ownership/schema.graphql.cjs';
import ExternalModule_6 from './sources/savestate/schema.graphql.cjs';
const importedModules = {
    ...
    // @ts-ignore
    ["@graphql-mesh/transform-prefix"]: ExternalModule_4,
    // @ts-ignore
    [".mesh/sources/ownership/schema.graphql.cjs"]: ExternalModule_5,
    // @ts-ignore
    [".mesh/sources/savestate/schema.graphql.cjs"]: ExternalModule_6
};
...
export async function getMeshOptions() {
    ...
    savestateTransforms.push(new PrefixTransform({
