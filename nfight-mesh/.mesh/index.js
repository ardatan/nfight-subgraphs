...
const transform_prefix_1 = (0, tslib_1.__importDefault)(require("@graphql-mesh/transform-prefix"));
...
const importedModules = {
    ...
    // @ts-ignore
    ["@graphql-mesh/transform-prefix"]: transform_prefix_1.default,
    // @ts-ignore
...
const transform_prefix_2 = (0, tslib_1.__importDefault)(require("@graphql-mesh/transform-prefix"));
const utils_4 = require("@graphql-mesh/utils");
exports.rawConfig = { "sources": [{ "name": "ownership", "handler": { "graphql": { "endpoint": "https://api.thegraph.com/subgraphs/name/sbauch/nfight-ownership" }, "batch": true }, "transforms": [{ "typeMerging": { "queryFields": [{ "queryFieldName": "fighters", "keyField": "id", "keyArg": "where.id_in" }] } }] }, { "name": "savestate", "handler": { "graphql": { "endpoint": "https://api.thegraph.com/subgraphs/name/sbauch/nfight-gamedata" } }, "transforms": [{ "prefix": { "value": "SS_", "includeRootOperations": true, "ignore": ["SyncStatus", "Fighter", "_SubgraphErrorPolicy_"] } }, { "typeMerging": { "queryFields": [{ "queryFieldName": "SS_fighter", "keyField": "id", "keyArg": "id" }] } }] }], "documents": ["./operations/**/*.graphql"], "serve": { "browser": true, "playground": true, "customServerHandler": "./server.js" } };
async function getMeshOptions() {
    ...
    const ownershipHandler = new graphql_2.default({
    ...
    const savestateHandler = new graphql_2.default({
    ...
    savestateTransforms.push(new transform_prefix_2.default({
        apiName: exports.rawConfig.sources[1].name,
        config: exports.rawConfig.sources[1].transforms[0]["prefix"],
        baseDir,
        cache,
        pubsub,
        importFn
    ...
    savestateTransforms.push(new transform_type_merging_2.default({
        apiName: exports.rawConfig.sources[1].name,
        config: exports.rawConfig.sources[1].transforms[1]["typeMerging"],
        baseDir,
        cache,
        pubsub,
        importFn
...
exports.documentsInSDL = [/* GraphQL */ `query getFighter($id: ID! = "0xb3ea7cbb180d834c279b06873b6a971cce7014681") {
  fighter(id: $id) {
    ...
    power
    speed
    syncs(orderBy: timestamp, first: 1, orderDirection: desc) {
      status
    }
  }
